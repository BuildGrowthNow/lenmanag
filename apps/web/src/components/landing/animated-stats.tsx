...
function AnimatedStat({ icon: Icon, value, suffix, label, delay = 0 }: StatProps) {
  ...
  return (
    <motion.div
      ...
      className="text-center p-4 md:p-6 rounded-2xl bg-white/5 md:backdrop-blur-sm border border-white/10 [@media(hover:hover)]:hover:border-yellow-500/50 md:transition-all group"
    >
