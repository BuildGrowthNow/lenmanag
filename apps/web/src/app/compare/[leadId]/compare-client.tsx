...
type SiteVariant = { siteId: string; variantLabel: string | null; variantTitle: string | null; variantDescription: string | null; variantPosition: number; optionNumber: number; previewUrl: string; screenshotUrl: string };
